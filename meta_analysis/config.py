...
RESULTS_BODY_DIR = CACHE_DIR / 'results_body'   # body text only (round-2 revision)
RESULTS_REFS_DIR = CACHE_DIR / 'results_refs'   # reference-list text only
PAPER_REVIEW = HERE / 'paper_review.json'        # DOI-keyed include/exclude decisions
